...
import com.myvocab.core.util.FAST_TRANSLATION_CHANNEL_ID
import com.myvocab.core.util.getNotificationIconId
import com.myvocab.fasttranslation.FastTranslationWidget
...
//        val notificationIntent = Intent(this, /*MainActivity::class.java*/ null)
//        notificationIntent.action = Constants.MAIN_ACTION
//        notificationIntent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
//        val pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0) todo refactor

        return NotificationCompat.Builder(this, FAST_TRANSLATION_CHANNEL_ID)
                .setContentTitle(getString(R.string.fast_translation))
                .setTicker(getString(R.string.fast_translation))
                ...
                .setContentText(getString(R.string.fast_translation_notification_content))
